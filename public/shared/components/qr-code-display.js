...
const QR_SCRIPT = "/vendor/qrcode/qrcode.js";
...
export class BuiltinQrCodeDisplay extends BuiltinBaseElement {
  ...
  async _generate() {
    try {
      const QRCode = await loadQrScript();
      ...
      new QRCode(target, {
        ...
        correctLevel: this.logo ? QRCode.CorrectLevel.H : QRCode.CorrectLevel.M,
      });
      this._error = "";
    } catch (err) {
