...
class ContainerSet[T](set[T]):
    ...
    def __init__(self, 
                 *args, 
                 validator:Callable[[set, set], bool]|None=None, 
                 iter_validator:Callable[[Any, Any], bool]|None=None, 
                 **kwargs): 
        '''
        Args:
...
__all__ = ['ContainerSet', 'CaseIgnoreStrSet', 'RangeSet', 'FuzzySet']