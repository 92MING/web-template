...
def register_storage_orm_routes(app: FastAPI):
    ...
    @app.get("/admin/storage/orm")
    async def storage_orm_page():
        return storage_html_response("orm")

    @app.get("/admin/api/storage/orm/clients", response_model=StorageClientsResponse)
    ...
    @app.get("/admin/api/storage/orm/config", response_model=ORMConfigResponse)
    ...
    @app.get("/admin/api/storage/orm/collections", response_model=ORMCollectionsResponse)
    ...
    @app.get("/admin/api/storage/orm/schema", response_model=ORMSchemaResponse)
    ...
    @app.get("/admin/api/storage/orm/indexes", response_model=ORMIndexesResponse)
    ...
    @app.post("/admin/api/storage/orm/index", response_model=ORMIndexMutationResponse)
    ...
    @app.delete("/admin/api/storage/orm/index", response_model=ORMIndexMutationResponse)
    ...
    @app.post("/admin/api/storage/orm/query", response_model=ORMQueryResponse)
    ...
    @app.post("/admin/api/storage/orm/collection", response_model=ORMCollectionActionResponse)
    ...
    @app.post("/admin/api/storage/orm/collection/rename", response_model=ORMCollectionActionResponse)
    ...
    @app.get("/admin/api/storage/orm/document", response_model=ORMDocumentResponse)
    ...
    @app.put("/admin/api/storage/orm/document", response_model=ORMUpsertResponse)
    ...
    @app.delete("/admin/api/storage/orm/document", response_model=ORMDeleteResponse)
    ...
    @app.post("/admin/api/storage/orm/delete-many", response_model=ORMDeleteManyResponse)
    ...
    @app.patch("/admin/api/storage/orm/expire", response_model=ORMExpireResponse)
    ...
    @app.delete("/admin/api/storage/orm/collection", response_model=ORMCollectionActionResponse)
    ...
    @app.post("/admin/api/storage/orm/cleanup", response_model=StorageCleanupResponse)
