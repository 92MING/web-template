...
def register_storage_vector_routes(app: FastAPI):
    ...
    @app.get(admin_path("storage/vector"))
    async def storage_vector_page():
        return storage_html_response("orm")

    @app.get(admin_path("api/storage/vector/clients"), response_model=StorageClientsResponse)
    ...
    @app.get(admin_path("api/storage/vector/config"), response_model=VectorConfigResponse)
    ...
    @app.get(admin_path("api/storage/vector/collections"), response_model=VectorCollectionsResponse)
    ...
    @app.get(admin_path("api/storage/vector/collection"), response_model=VectorCollectionDetailResponse)
    ...
    @app.get(admin_path("api/storage/vector/schema"), response_model=VectorSchemaResponse)
    ...
    @app.post(admin_path("api/storage/vector/collection"), response_model=VectorCollectionCreateResponse)
    ...
    @app.post(admin_path("api/storage/vector/browse"), response_model=VectorBrowseResponse)
    ...
    @app.get(admin_path("api/storage/vector/document"), response_model=VectorDocumentResponse)
    ...
    @app.put(admin_path("api/storage/vector/document"), response_model=VectorUpsertResponse)
    ...
    @app.post(admin_path("api/storage/vector/search"), response_model=VectorSearchResponse)
    ...
    @app.post(admin_path("api/storage/vector/search/upload"), response_model=VectorSearchResponse)
    ...
    @app.post(admin_path("api/storage/vector/delete-many"), response_model=VectorDeleteManyResponse)
    ...
    @app.delete(admin_path("api/storage/vector/document"), response_model=VectorDeleteResponse)
    ...
    @app.delete(admin_path("api/storage/vector/collection"), response_model=VectorCollectionActionResponse)
    ...
    @app.post(admin_path("api/storage/vector/collection/rename"), response_model=VectorCollectionActionResponse)
    ...
    @app.post(admin_path("api/storage/vector/collection/load"), response_model=VectorCollectionActionResponse)
    ...
    @app.post(admin_path("api/storage/vector/collection/offload"), response_model=VectorCollectionActionResponse)
    ...
    @app.patch(admin_path("api/storage/vector/expire"), response_model=VectorExpireResponse)
    ...
    @app.post(admin_path("api/storage/vector/cleanup"), response_model=StorageCleanupResponse)
